...
export default function AccessSection() {
  ...
  return (
    <section id="access" className="py-14 md:py-24">
      <div className="container-w grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <dl className="grid gap-3 text-sm mt-4">
            <div className="grid grid-cols-[6rem_1fr] gap-2">
              <dt className="font-semibold text-neutral-400">{t("station")}</dt>
            ...
            <div className="grid grid-cols-[6rem_1fr] gap-2">
              <dt className="font-semibold text-neutral-400">{t("parking")}</dt>
              <dd className="text-neutral-300">{t("parkingValue")}</dd>
            </div>
            <div className="grid grid-cols-[6rem_1fr] gap-2">
              <dt className="font-semibold text-neutral-400">{t("hours")}</dt>
              <dd className="text-neutral-300">
        ...
        <div className="rounded-2xl overflow-hidden shadow-soft aspect-[4/3] w-full bg-neutral-800">
          <iframe

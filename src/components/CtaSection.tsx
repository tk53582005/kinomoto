      ...
      <div className="container-w card shadow-soft">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-5">
            {socials.map((s) => (
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label} className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow hover:bg-neutral-100 hover:scale-105 transition">
                {s.icon}
              </a>
            ))}
          </div>
